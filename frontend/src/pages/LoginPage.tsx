...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // On success the auth state listener in App.tsx will handle the redirect
    } catch (err) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full max-w-sm px-8 py-10">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-semibold text-gray-800">Miller Waste Systems</h1>
          <p className="text-sm text-gray-500 mt-1">Invoice Parser — FP&A</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              placeholder="you@millerwaste.ca"
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          Access is restricted to authorized Miller Waste staff.
        </p>
      </div>
    </div>
  )
